...
````
Create the final submission document at:
/Users/rishav00a/Projects/rishav_andela_submission.md

NOTE: This file is outside the django-nocturne repo — it sits 
directly in the Projects folder. Do NOT create it inside 
django-nocturne/.

This is the official assessment submission for Wolters Kluwer GTS 
...
# Wolters Kluwer GTS — Vibe Coding Assessment Submission
...
**Daily AI Tools:** ChatGPT, Claude, Gemini, Microsoft Copilot, 
GitHub Copilot, Midjourney, Notion AI  

**Profile Summary:**  
Operates with high technical self-efficacy, treating intelligence as 
a tool to be sharpened. Comfortable navigating macro-level AI shifts, 
treating complex systems as puzzles to be solved. High internal locus 
of control enables quick pivoting when facing technical hurdles.

**Key Strengths identified by Tagle:**
- Technical Self-Reliance: Daily AI tool usage without waiting for 
  institutional adoption
- Analytical Synthesis: Ability to connect disparate domains and 
  spot patterns others miss
- Resilience in Problem-Solving: Views failure as data, enabling 
  rapid iteration without ego

**Relevance to this project:**  
The Architect tag directly shaped this submission — rather than 
building a standalone script, I designed a reusable, pip-installable 
Django package with a 3-layer AI pipeline, full documentation, 
CI/CD, and PyPI distribution. Depth over breadth.
...
| prompts.md audit log | ✅ Complete | https://github.com/rishav00a/django-nocturne/blob/main/prompts.md |
| Architecture Presentation | ✅ Complete | https://github.com/rishav00a/django-nocturne/blob/main/presentation.md |
...
| 🧪 Live Demo Repository | https://github.com/rishav00a/nocturne-demo |
...
**Why this project:**
- Most aligned with the Agentic Orchestration theme emphasized 
  in the brief
- No real cloud account needed — synthetic logs avoid accidental 
  cloud costs entirely
- Webhook + dashboard combination creates the most visually 
  impressive and verifiable demo
- SRE/observability is a high-value skill in enterprise 
  platform engineering
- Allowed me to go deeper than a script — built a real 
  open source package
...
Rather than a standalone app, I built **django-nocturne** — 
a reusable, pip-installable Django observability package that 
any Django project can attach to with 3 lines of configuration.
...
The assessment required "AI logic" for anomaly detection.
...
- Industry-standard approach used by Datadog, New Relic, 
  Prometheus
...
- When anomaly confirmed, sends last 50 log entries + stacktrace 
  to an LLM via LangChain
...
## 📦 Package Architecture django-nocturne/
...
- ✅ prompts.md maintained with full chronological audit log
- ✅ Same AI tool (Claude) used end-to-end for consistency
- ✅ Human-in-the-Loop: I made all architectural decisions,
     AI executed all implementation
...
The Tagle assessment identified me as an Architect who goes deep 
while others scan headlines. This submission directly reflects that:
...
The growth opportunity Tagle identified — moving from solo operator 
to team-based innovator — is directly addressed by making this 
open source. Anyone can now `pip install django-nocturne` and 
benefit from this work, and contributions are welcome via GitHub.
...
| 📝 Prompts Audit Log | https://github.com/rishav00a/django-nocturne/blob/main/prompts.md |
| 🎯 Architecture Deck | https://github.com/rishav00a/django-nocturne/blob/main/presentation.md |
...
1. Verify the file was created at the correct path:
   ls /Users/rishav00a/Projects/rishav_andela_submission.md

2. Verify it is NOT inside django-nocturne/:
   This file should be at /Users/rishav00a/Projects/ 
   NOT at /Users/rishav00a/Projects/django-nocturne/

3. Open the file and confirm it renders correctly:
   cat /Users/rishav00a/Projects/rishav_andela_submission.md | head -50

4. Check word count:
   wc -w /Users/rishav00a/Projects/rishav_andela_submission.md

5. This file does NOT need to be committed to any git repo —
   it is a standalone submission document to be shared directly
   with the assessor.
